...
extern "C" {
	...
	pub fn LLVMGetInlineAsmDialect(
		InlineAsmVal: LLVMValueRef,
	...
	pub fn LLVMGetInlineAsmFunctionType(
		InlineAsmVal: LLVMValueRef,
	) -> LLVMTypeRef;

	/// Get if the inline asm snippet has side effects
	pub fn LLVMGetInlineAsmHasSideEffects(
		InlineAsmVal: LLVMValueRef,
	) -> LLVMBool;

	/// Get if the inline asm snippet needs an aligned stack
	pub fn LLVMGetInlineAsmNeedsAlignedStack(
		InlineAsmVal: LLVMValueRef,
	) -> LLVMBool;
...
extern "C" {
	...
	pub fn LLVMGetConstantPtrAuthPointer(PtrAuth: LLVMValueRef)
		-> LLVMValueRef;
	...
	pub fn LLVMGetTargetExtTypeName(
		TargetExtTy: LLVMTypeRef,
	) -> *const ::libc::c_char;

	/// Obtain the number of type parameters for this target extension type.
	pub fn LLVMGetTargetExtTypeNumTypeParams(
		TargetExtTy: LLVMTypeRef,
	) -> ::libc::c_uint;
	...
	pub fn LLVMGetTargetExtTypeNumIntParams(
		TargetExtTy: LLVMTypeRef,
	) -> ::libc::c_uint;
...
extern "C" {
	...
	pub fn LLVMPrintDbgRecordToString(
	...
	pub fn LLVMGetAggregateElement(
		C: LLVMValueRef,
		idx: ::libc::c_uint,
	) -> LLVMValueRef;
	...
	pub fn LLVMGetBlockAddressFunction(BlockAddr: LLVMValueRef)
		-> LLVMValueRef;
	/// Gets the basic block associated with a given BlockAddress constant value.
	pub fn LLVMGetBlockAddressBasicBlock(
...
extern "C" {
	...
	pub fn LLVMGetNumOperandBundleArgs(
		Bundle: LLVMOperandBundleRef,
	) -> ::libc::c_uint;
...
extern "C" {
	...
	pub fn LLVMGetCallBrNumIndirectDests(
		CallBr: LLVMValueRef,
	) -> ::libc::c_uint;
