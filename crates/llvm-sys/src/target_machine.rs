...
extern "C" {
	...
	pub fn LLVMDisposeTargetMachineOptions(
	...
	pub fn LLVMSetTargetMachineFastISel(
		T: LLVMTargetMachineRef,
		Enable: LLVMBool,
	);
	/// Enable global instruction selection.
	pub fn LLVMSetTargetMachineGlobalISel(
		T: LLVMTargetMachineRef,
		Enable: LLVMBool,
	);
	...
	pub fn LLVMSetTargetMachineMachineOutliner(
		T: LLVMTargetMachineRef,
		Enable: LLVMBool,
	);
